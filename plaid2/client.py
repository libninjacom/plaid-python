...
class PlaidClient:
    ...
    def item_get(self, access_token: str) -> model.ItemGetResponse:
        ...
        r = requests.post(
            self.base_url + "/item/get", headers=headers, params=params, data=data
        )
        r.raise_for_status()
        data = r.json()
    ...
    def auth_get(
        ...
        r = requests.post(
            self.base_url + "/auth/get", headers=headers, params=params, data=data
        )
        r.raise_for_status()
        data = r.json()
    ...
    def item_remove(self, access_token: str) -> model.ItemRemoveResponse:
        ...
        r = requests.post(
            self.base_url + "/item/remove", headers=headers, params=params, data=data
        )
        r.raise_for_status()
        data = r.json()
    ...
    def accounts_get(
        ...
        r = requests.post(
            self.base_url + "/accounts/get", headers=headers, params=params, data=data
        )
        r.raise_for_status()
        data = r.json()
    ...
    def categories_get(self) -> model.CategoriesGetResponse:
        ...
        data = {}
        r = requests.post(
            self.base_url + "/categories/get", headers=headers, params=params, data=data
        )
        r.raise_for_status()
        data = r.json()
    ...
    def identity_get(
        ...
        r = requests.post(
            self.base_url + "/identity/get", headers=headers, params=params, data=data
        )
        r.raise_for_status()
        data = r.json()
    ...
    def identity_match(
        ...
        r = requests.post(
            self.base_url + "/identity/match", headers=headers, params=params, data=data
        )
        r.raise_for_status()
        data = r.json()
    ...
    def user_create(self, client_user_id: str) -> model.UserCreateResponse:
        ...
        r = requests.post(
            self.base_url + "/user/create", headers=headers, params=params, data=data
        )
        r.raise_for_status()
        data = r.json()
    ...
    def item_import(
        ...
        r = requests.post(
            self.base_url + "/item/import", headers=headers, params=params, data=data
        )
        r.raise_for_status()
        data = r.json()
    ...
    def link_token_get(self, link_token: str) -> model.LinkTokenGetResponse:
        ...
        r = requests.post(
            self.base_url + "/link/token/get", headers=headers, params=params, data=data
        )
        r.raise_for_status()
        data = r.json()
    ...
    def transfer_get(self, transfer_id: str) -> model.TransferGetResponse:
        ...
        r = requests.post(
            self.base_url + "/transfer/get", headers=headers, params=params, data=data
        )
        r.raise_for_status()
        data = r.json()
    ...
    def transfer_list(
        ...
        r = requests.post(
            self.base_url + "/transfer/list", headers=headers, params=params, data=data
        )
        r.raise_for_status()
        data = r.json()
    ...
    def signal_prepare(self, access_token: str) -> model.SignalPrepareResponse:
        ...
        r = requests.post(
            self.base_url + "/signal/prepare", headers=headers, params=params, data=data
        )
        r.raise_for_status()
        data = r.json()
    ...
    def wallet_create(self, iso_currency_code: str) -> model.WalletCreateResponse:
        ...
        r = requests.post(
            self.base_url + "/wallet/create", headers=headers, params=params, data=data
        )
        r.raise_for_status()
        data = r.json()
    ...
    def wallet_get(self, wallet_id: str) -> model.WalletGetResponse:
        ...
        r = requests.post(
            self.base_url + "/wallet/get", headers=headers, params=params, data=data
        )
        r.raise_for_status()
        data = r.json()
    ...
    def wallet_list(
        ...
        r = requests.post(
            self.base_url + "/wallet/list", headers=headers, params=params, data=data
        )
        r.raise_for_status()
        data = r.json()
